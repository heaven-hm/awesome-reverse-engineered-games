...
| **5** | **Chromatron** (~2005) | 2005 (WinXP/PPC) | Laser / Mirror Puzzle | Claude Code + Cursor + Ghidra (GhidrAssistMCP) | **Iterative (Days/Weeks)** | Cross-platform native ports on Apple Silicon (macOS) and WebAssembly browser. |
